    ...
    return (
        <div>
          ...
          <p className='mt-4 text-xl font-medium leading-8 tracking-tight '>
            You can contact me via <InlineLink href='mailto:jefferson@jeffersonrj.com'>jefferson@jeffersonrj.com</InlineLink>, <InlineLink href='https://twitter.com/jeffersonrj14'>Twitter DM</InlineLink> or through <InlineLink href='https://discordapp.com/users/606481557615542273'>Discord</InlineLink>.
            <br/>If you want to have a more secure channel of communication, you can also reach me on <InlineLink href="https:keybase.io/jeffersonrj14">Keybase</InlineLink>
          </p>
        </div>
    )
}
