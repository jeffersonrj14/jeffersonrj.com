  ...
  return (
    <div className='flex flex-col pt-10'>
      ...
      <p className='mt-4 text-xl font-medium leading-8 tracking-tight'>
        ...
        beyond the college curriculum in order to establish a solid fundamental understanding. So, I
        started taking online classes after I graduated.
      </p>
      <p className='mt-4 text-xl font-medium leading-8 tracking-tight'>
        ...
        occasionally repost videos from Vtuber with English subtitles so that viewers can understand
        what these Vtuber Japanese Talent are talking about.
      </p>
      <p className='mt-4 text-xl font-medium leading-8 tracking-tight'>
        With knowledge under my belt, I went on to learn new programming languages. In the future, I
