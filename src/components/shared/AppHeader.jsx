      ...
      <div className='z-10 max-w-screen-lg xl:max-w-screen-xl block sm:flex sm:justify-between sm:items-center py-6'>
        ...
        <div className='flex justify-between items-center px-4 sm:px-0'>
          ...
          <div
            ...
            className='block sm:hidden ml-40 bg-jefferson-light dark:bg-jefferson-dark hover:bg-jefferson-maindark hover:dark:bg-jefferson-main text-jefferson-dark hover:text-jefferson-light dark:text-jefferson-light hover:dark:text-jefferson-dark p-3 shadow-lg rounded-xl cursor-pointer'
          >
            {activeTheme === 'dark' ? (
          ...
          <div className='sm:hidden'>
            ...
            >
              <svg
                ...
                viewBox='0 0 24 24'
                className='h-7 w-7 fill-current text-jefferson-dark dark:text-ternary-light'
              >
        ...
        >
          <div className='block text-left text-lg text-jefferson-dark dark:text-ternary-light dark:hover:text-jefferson-light hover:text-jefferson-maindark  sm:mx-4 mb-2 sm:py-2 border-t-2 pt-3 sm:pt-2 sm:border-t-0 border-secondary-dark'>
            <Link href='/about' aria-label='About Me'>
              About
            </Link>
          </div>
          <div className='block text-left text-lg text-jefferson-dark dark:text-ternary-light dark:hover:text-jefferson-light hover:text-jefferson-maindark sm:mx-4 mb-2 sm:py-2'>
        ...
        <div className='font-general-medium hidden m-0 sm:ml-4 mt-5 sm:mt-3 sm:flex p-5 sm:p-0 justify-center items-center shadow-lg sm:shadow-none'>
          <div
            className='block text-left text-lg font-medium text-jefferson-dark dark:text-ternary-light dark:hover:text-jefferson-light hover:text-jefferson-maindark sm:mx-4 mb-2 sm:py-2'
            aria-label='About Me'
          >
