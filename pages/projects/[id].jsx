		...
		<div className="container mx-auto">
			...
			<div className="block sm:flex gap-0 sm:gap-10 mt-14">
				<div className="w-full sm:w-1/3 text-left">
					...
					<div className="mb-7">
						<p className="font-general-regular text-3xl font-semibold text-secondary-dark dark:text-secondary-light mb-2">
							{props.project.ProjectInfo.ProjectHeading}
						</p>
						<ul className="leading-loose text-xl">
							{props.project.ProjectInfo.ProjectAboutInfo.map(
								(info) => {
									return (
										<li
										...
										>
											...
											<a
												...
												className={
													info.title === 'Website' ||
													info.title === 'Github'
														? 'text-jefferson-maindark dark:text-jefferson-main decoration-wavy decoration-2 underline-offset-4 transition-all hover:underline hover:text-jefferson-dark dark:hover:text-jefferson-light cursor-pointer duration-300'
														: ''
												}
					...
					<div className="mb-7">
						<p className="font-general-regular text-3xl font-semibold text-ternary-dark dark:text-ternary-light mb-2">
						...
						<p className="font-general-regular text-primary-dark dark:text-ternary-light">
							...
							{props.project.ProjectInfo.FeatureDetails.map((details) => {
								return (
									<li key={details.id}>・{details.details}</li>
								);
							})}
							</ul>
						</p>
